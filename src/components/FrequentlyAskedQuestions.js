        ...
        <section className="section-FrequentlyAsked">
            <div className="container">
                ...
                <div className="FrequentlyAsked_imgsec">
                   <img loading="lazy" src={img1} className='frequentlyAskedimg frequentlyAsked_img1' alt="group-1" />
                   <img loading="lazy" src={img2} className='frequentlyAskedimg frequentlyAsked_img2' alt="group-2" />
                   <img loading="lazy" src={img3} className='frequentlyAskedimg frequentlyAsked_img3' alt="group-3" />
                   <img loading="lazy" src={img4} className='frequentlyAskedimg frequentlyAsked_img4' alt="group-4" />
            </div>
