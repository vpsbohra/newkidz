            ...
            <div className="before_you_go">
                <div className="before_you_go_inner">
                    ...
                    <div className="before_you_go_content">
                        <img loading="lazy" src={before_you_go} />
                        <p>Are you sure about your decision? We'd like you to consider our Souvenir subscription plan. It not only allows you to retain your account data and conversations but also ensures that your cherished memories are preserved, even if you think your child won't be using the account anymore or has outgrown it. This valuable service comes at a nominal fee of just 2,5€ per month.</p>
