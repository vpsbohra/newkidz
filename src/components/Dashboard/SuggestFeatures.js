            ...
            <div className="suggest-features">
                ...
                <div className="content">
                    ...
                    <div className="emotes">
                        ...
                        >
                            <img loading="lazy" className='normal_review' src={AngryImg} alt="protected" />
                            <img loading="lazy" className='active_review' src={Angry_activeImg} alt="protected" />
                        ...
                        >
                            <img loading="lazy" className='normal_review' src={ConfusedImg} alt="protected" />
                            <img loading="lazy" className='active_review' src={Confused_activeImg} alt="protected" />
                        </Link>
                        <Link
                            onClick={() => handleEmoteClick(2)}
                            className={activeEmoteIndex === 2 ? 'activeemote' : ''}
                        >
                            <img loading="lazy" className='normal_review' src={NeutralImg} alt="protected" />
                            <img loading="lazy" className='active_review' src={Neutral_activeImg} alt="protected" />
                        </Link>
                        <Link
                            onClick={() => handleEmoteClick(3)}
                            className={activeEmoteIndex === 3 ? 'activeemote' : ''}
                        >
                            <img loading="lazy" className='normal_review' src={HappyImg} alt="protected" />
                            <img loading="lazy" className='active_review' src={Happy_activeImg} alt="protected" />
                        </Link>
                        <Link
                            onClick={() => handleEmoteClick(4)}
                            className={activeEmoteIndex === 4 ? 'activeemote' : ''}
                        >
                            <img loading="lazy" className='normal_review' src={LoveItImg} alt="protected" />
                            <img loading="lazy" className='active_review' src={LoveIt_activeImg} alt="protected" />
                        </Link>
                    </div>
